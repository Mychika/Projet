        ...
        for(j=0;j<15;j++) //colonnes
            {
                ...
                {
                setColor(FOREGROUND_RED | FOREGROUND_INTENSITY | surligne); //Passe en rouge le texte
                ...
                {
                setColor(FOREGROUND_GREEN | FOREGROUND_INTENSITY | surligne); //Passe en rouge le texte
                printf("%c ",matrice[i][j]);
                setColor(FOREGROUND_WHITE);
                }
                ...
                {
                setColor(FOREGROUND_BLUE | FOREGROUND_INTENSITY | surligne); //Passe en rouge le texte
                printf("%c ",matrice[i][j]);
                setColor(FOREGROUND_WHITE);
                }
                ...
                {
                setColor(FOREGROUND_PURPLE | FOREGROUND_INTENSITY | surligne); //Passe en rouge le texte
                printf("%c ",matrice[i][j]);
                setColor(FOREGROUND_WHITE);
                }
                ...
                {
                setColor(FOREGROUND_CYAN | FOREGROUND_INTENSITY | surligne); //Passe en rouge le texte
                printf("%c ",matrice[i][j]);
                setColor(FOREGROUND_WHITE);
                }
            }
